  ...
  execute(msg, args) {
    msg.channel.send(`
        ...
        ** Adding a user **
        ...
        Users must be added to the database before you can track data
        for them.
        ...
        ** Debts **
        ...
        Debts between users can be added using the command below.The first user will always be the 'owing user'
        and the second with be the 'collecting user'

        \`tb!adddebt @owing_user @collecting_user amount\`

        ** Transactions **

        Transactions are used to track how much has been paid between users.The first user will always be the 'paying user'
        and the second will be the 'receiving user'
